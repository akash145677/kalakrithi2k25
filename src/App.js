  ...
  const clubs = [
    {
      ...
      logo: "/logos/dance-logo.png", // place your club logo in public/logos
          ...
          >
            ...
            <div className="flex-1 p-6 flex flex-col justify-center">
              <div className="flex items-center space-x-3 mb-3">
                <img src={club.logo} alt={club.name} className="h-10 w-10 rounded-full" />
            ...
            <div className="flex-1">
              <img src={club.img} alt={club.name} className="w-full h-56 md:h-full object-cover" />
            </div>
          </div>
        ))}
      </div>
